                    ...
                    <div class="dropdown-menu">
                      <div class="row">
                        <div class="col-lg-6">
                          ...
                          <div class="row">
                            <div class="col-lg-6"> <a href="intro.html" class="dropdown-item">Intro</a> <a href="index.html" class="dropdown-item active">Homepage (default)</a> <a href="index-static.html" class="dropdown-item">Homepage No Slider</a> <a href="index-boxed.html"
                                class="dropdown-item active">Homepage Boxed</a> <a href="index-promo-header.html" class="dropdown-item">Promo Header</a> <a href="index-coming-soon.html" class="dropdown-item">Coming Soon</a> <a href="index-coming-soon-newsletter.html"
                                class="dropdown-item">Coming Soon with newsletter</a> <a href="index-onepager.html" class="dropdown-item">One Pager Slideshow</a> </div>
                        ...
                        <div class="tab-pane active show menu-tab-1" role="tabpanel">
                          <div class="row text-center">
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Appellatio cogo haero pala premo saepius tation typicus uxor valetudo.</p>
                            </div>
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Aliquam meus natu pala paulatim probo quibus secundum suscipit uxor.</p>
                            </div>
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Meus modo mos obruo paulatim praesent probo tego ymo.</p>
                            </div>
                          </div>
                        </div>
                        <div class="tab-pane menu-tab-2" role="tabpanel">
                          <div class="row text-center">
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Abigo consectetuer dolus sed ymo.</p>
                            </div>
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Paulatim tincidunt typicus. Autem damnum esca feugiat incassum occuro oppeto.</p>
                            </div>
                            <div class="col-lg-4 py-2">
                              ...
                              <p class="text-sm mb-0">Augue secundum volutpat. Commoveo iustum luctus magna nisl premo roto valde ymo.</p>
                            </div>
                          </div>
                        </div>
                      </div>
