    ...
    themeSubMenus: function() {
      ...
      context.find(".dropdown.dropdown-persist .dropdown-menu").on({
        click: function(event) {
          $(this)
            .parent(".dropdown.dropdown-persist")
            .data("closable", false);
        }
      });
    },
    ...
    themeCustomScripts: function(refresh) {
              ...
              function() {
                $element
                  ...
                  .one(
                    ...
                    function() {
                      $element
                        .removeClass("animated " + animateClass)
                        .addClass("animated " + animateClassOut);
                    }
                  );
              },
              function() {}
      ...
      context.find('[data-scroll="scroll-state"]').each(function() {
        var $scroll = $(this),
          ...
          scrollEffectIn =
            scrollSettings !== null ? scrollSettings.effectIn || null : null,
          scrollEffectOut =
            scrollSettings !== null ? scrollSettings.effectOut || null : null,
          scrollEffectDelay =
            scrollSettings !== null ? scrollSettings.effectDelay || null : null,
          scrollEffectDuration =
            scrollSettings !== null
              ? scrollSettings.effectDuration || null
              : null,
          scrollBreakpoint =
            scrollSettings !== null ? scrollSettings.breakpoint || null : null,
          scrollFallbackState =
            scrollSettings !== null
              ? scrollSettings.fallbackState || "scroll-state-active"
              : null,
          scrollActive = $scroll.data("scroll-active") || true,
          scrollPersist =
            scrollSettings !== null ? scrollSettings.persist || null : null,
        ...
        $doc.scroll(function() {
          ...
          $scroll.css({
            ...
            transform:
              yRatio === "off"
                ? 0
                : "translateY(" + (0 - windowTop / yRatio) + "px)"
          });
        });
      });
      ...
      context
        .find("[data-accordion-focus]")
        .on("shown.bs.collapse", function(e) {
          var headingTop = $(e.target)
            .parent()
            .offset().top;
          var scrollTo = $document.calcHeightsOffset(
            headingTop,
            $("#header").outerHeight()
          );
          $("html,body").animate(
      ...
      function modalAnimate($m, s, e) {
        ...
        $m.addClass(animateAdd + "  animated").one(
          "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
          function() {
      ...
      var $modalsAnimate = context.find(
        "[data-modal-animate-in], [data-modal-animate-out]"
      );
      if ($modalsAnimate.length > 0) {
        var $modalBackdrop = $("<div></div>").addClass(
  ...
  if ($backstretches.length > 0) {
    var themePluginBackstretchInit = function() {
      $backstretches.each(function() {
        ...
        jQuery.each(backstretchEl.data("backstretch-imgs").split(","), function(
          k,
          img
        ) {
          ...
          if (backstretchEl.data("backstretch-overlay") !== false) {
            ...
            if (backstretchEl.data("backstretch-overlay-opacity")) {
              $(".backstretch")
                ...
                .fadeTo(0, backstretchEl.data("backstretch-overlay-opacity"));
            }
          }
        }
      });
...
Globals.PLUGINS.themePluginBlazy = function(context) {
  ...
  if ($blazys.length > 0 || $blazy_bgs.length > 0) {
    ...
    $document.themeLoadPlugin(
      ...
      ["plugin-css/plugin-blazy.min.css"],
...
Globals.PLUGINS.themePluginBootstrapSelect = function(context) {
  ...
  // ----------------------------------------------------------------
  var $selects = context.find(
    '[data-toggle="select"], [data-toggle="selects"] select'
  );
  ...
  if ($selects.length > 0) {
    $document.themeLoadPlugin(
      ...
      [
        "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.0-beta/css/bootstrap-select.min.css",
        "plugin-css/plugin-bootstrap-select.min.css"
      ],
...
Globals.PLUGINS.themePluginBootstrapSwitch = function(context) {
  ...
  if ($bootstrapSwitches.length > 0) {
    ...
    $document.themeLoadPlugin(
      ...
      [
        "plugin-css/plugin-bootstrap-switch.min.css",
  ...
  if ($cubePortfolios.length > 0) {
    $document.themeLoadPlugin(
      [
        ...
        "cubeportfolio-jquery-plugin/cubeportfolio/js/jquery.cubeportfolio.min.js"
      ],
      [
        "plugin-css/plugin-magnific-popup.min.css",
        "plugin-css/plugin-cube-portfolio.min.css",
        "cubeportfolio-jquery-plugin/cubeportfolio/css/cubeportfolio.min.css"
      ],
...
//             if (
//               this.options.mindViewport &&
//               !this._isViewportAvailable() &&
//               _unsticking === false
//             ) {
//               return false;
//             }
...
//         var persistTop =
//           sticky.prev()[0].getBoundingClientRect().top + $(window).scrollTop();
//         if (persistTop < 0) {
//           persistTop = 0;
//         }
...
Globals.PLUGINS.themePluginFlexslider = function(context) {
  ...
  if ($flexsliders.length > 0) {
    ...
    $document.themeLoadPlugin(
      ...
      ["plugin-css/plugin-flexslider.min.css", "flexslider/flexslider.css"],
...
Globals.PLUGINS.themePluginOffCanvas = function(context) {
  ...
  // ----------------------------------------------------------------
  var $offCanvass = context.find(
    '[data-toggle="jpanel-menu"],[data-toggle="off-canvas"]'
  );
  if ($offCanvass.length > 0) {
    var themePluginOffCanvasInit = function() {
      ...
      var $excludedContent =
        $(
          ".jpanel-menu-exclude,.js-off-canvas-exclude,.modal,.colour-switcher"
        ) || null;
      ...
      var defaultSettings = {
        ...
        cloneTarget: true,
        modalClassExtras:
          "overlay overlay-dark overlay-op-4 overlay-close-cursor",
        targetClassExtras: ""
      };
      ...
      $offCanvass.each(function() {
        ...
        $offCanvas.addClass(
          "js-offcanvas-trigger js-offcanvas-trigger-" + uniqid
        );
        ...
        if ($target) {
          ...
          if (settings.cloneTarget) {
            ...
            $sideBarWrap
              .addClass(targetClasses + " js-offcanvas-target-clone")
              .attr("id", targetID)
              .append($targetClone)
              .appendTo("body");
            $target = $sideBarWrap;
    ...
    $document.themeLoadPlugin(
      ...
      [
        "https://unpkg.com/js-offcanvas@1.2.8/dist/_css/prefixed/js-offcanvas.css",
        "plugin-css/plugin-offcanvas.min.css"
      ],
...
Globals.PLUGINS.themePluginOwlCarousel = function(context) {
  ...
  if ($owlCarousels.length > 0) {
    ...
    $document.themeLoadPlugin(
      ...
      [
        "plugin-css/plugin-owl-carousel.min.css",
...
Globals.PLUGINS.themePluginSliderRevolution = function(context) {
  ...
  if ($sliderRevolutions.length > 0) {
    var themePluginSliderRevolutionInit = function() {
      ...
      $sliderRevolutions.each(function() {
        ...
        sliderRevSettings = $.extend(
          ...
          sliderRevEl.data("settings")
        );

        if (customInit) {
          sliderRevEl
            .addClass("custom-init")
            .trigger("appstrap:sliderRev:customInit", [sliderRevSettings]);
          return;
        } else {
          sliderRevEl.hide();
          var sliderAPI = sliderRevEl
            .addClass("standard-init")
            .show()
            .revolution(sliderRevSettings);
          sliderRevEl.trigger("appstrap:sliderRev:standardInit", [
            sliderRevSettings
          ]);
    ...
    $document.themeLoadPlugin(
      ...
      [
        "plugin-css/plugin-slider-revolution.min.css",
...
Globals.PLUGINS.themePluginZoom = function(context) {
  ...
  if ($zooms.length > 0) {
    ...
    $document.themeLoadPlugin(
      [
        "https://cdnjs.cloudflare.com/ajax/libs/jquery-zoom/1.7.20/jquery.zoom.min.js"
      ],
      [],
      themePluginZoomInit
    );
